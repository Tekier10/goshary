import Link from 'next/link'; import { useState, useEffect } from 'react'; import { useRouter } from 'next/router'; import { FiSearch, FiHeart, FiBell, FiUser, FiMenu } from 'react-icons/fi';
